  ...
  return (
    <div className="bg-[#F1F1F1] -mt-40 dark:bg-gray-900">
      <div className="max-w-6xl mx-auto">
        ...
        {/* Grid starts here */}
        <div className="grid grid-cols-3 gap-8 lg:-mt-8 pb-40">
          {/* Single card */}
          <a
            href="https://jdlandscaping.net"
          ...
          {/* Single card */}
          <a
            href="https://unitedhardscapes.com"
